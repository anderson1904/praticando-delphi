...
var
  LCliente: TCliente;
begin
  for LCliente in FBanco.Clientes do
    ShowMessage(LCliente.CPF + ': '+LCliente.senha);
end;
...
var
  LConta: TConta;
begin
  for LConta in FBanco.Contas do
    ShowMessage(format('%s: %d',[LConta.Numero, LConta.Saldo]));
end;
